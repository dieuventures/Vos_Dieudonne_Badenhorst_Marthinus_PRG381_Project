...
public class birthDayParties implements events {
    
    String eventType = "Birthday Parties";
    String cStarters;
    String cMain;
    String cDessert;
    int numOfPeople;
    ...
    @Override public void getEventInformation(){
        ...
        System.out.println("Please enter the Theme of the Birthday Party");
        eventThemes = sc.nextLine();

        System.out.println("Please enter the address for the Birthday Party");
        eventAddress = sc.nextLine();

        System.out.println("Please enter the Theme of the Birthday Party");
        eventThemes = sc.nextLine();

        System.out.println("Please enter the date and the time of the Birthday Party");
